namespace MarketsIQ.Services.Google.Protobuf
{
        ...
        private static readonly Dictionary<string, Action<JsonParser, IMessage, JsonTokenizer>> WellKnownTypeHandlers = new Dictionary<string, Action<JsonParser, IMessage, JsonTokenizer>>
    {
        ...
        private void MergeWellKnownTypeAnyBody(IMessage body, JsonTokenizer tokenizer)
        {
            ...
            {
                throw new InvalidProtocolBufferException(string.Format("Expected '{0}' property for well-known type Any body", new object[1] { "value" }));
            }
                ...
                case FieldType.Enum:
                    {
                        ...
                        {
                            throw new InvalidProtocolBufferException(string.Format("Invalid enum value: {0} for enum type: {1}", new object[2]
                            {
                    text,
