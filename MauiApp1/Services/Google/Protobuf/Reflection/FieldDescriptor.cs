...
namespace MarketsIQ.Services.Google.Protobuf.Reflection
{
    public sealed class FieldDescriptor : DescriptorBase, IComparable<FieldDescriptor>
    {
        ...
        private IFieldAccessor CreateAccessor()
        {
            ...
            PropertyInfo property = TypeExtensions.GetProperty(ContainingType.ClrType, propertyName);
            if ((object)property == null)
            {
                throw new DescriptorValidationException(this, string.Format("Property {0} not found in {1}", new object[2] { propertyName, ContainingType.ClrType }));
            }
